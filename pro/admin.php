...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar  navbar-expand navbar-white navbar-light" style="background-color: #27a644;">
            <!-- Left navbar links -->
            ...
            <ul class="navbar-nav">
                ...
                <li class="navbar-nav">
                    <a class="nav-link" href="#" style="color: white;"><?php echo SITE_NAME ?></a>
        ...
        <aside class="main-sidebar sidebar-dark-success elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="images/vehiclelg.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="admin.php" class="nav-link <?php if (!isset($_GET['page'])) echo 'active'; ?>">
                                <i class="nav-icon fas fa-tachometer-alt" style="color: #535c66;"></i>                                <p style="color: white;">
                                    Home
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            ?>
                            ">
                                <i class="nav-icon fas fa-users" style="color: #535c66;"></i>
                                <p>
                                    Users
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            ...
                            ?>
                            ">
                                <i class="nav-icon fas fa-calendar-day" style="color: #535c66;"></i>
                                <p>
                                    Schedules
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=route" class="nav-link      <?php
                                                                                ...
                                                                                ?>">
                                <i class="nav-icon fas fa-route" style="color: #535c66;"></i>
                                <p>
                                    Routes
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=vehicle" class="nav-link      <?php
                                                                                echo (@$_GET['page'] == 'vehicle') ? 'active' : '';
                                                                                ?>">
                                <i class="nav-icon fas fa-car" style="color: #535c66;"></i>
                                <p>
                                    UV Express
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=report" class="nav-link      <?php
                                                                                    ...
                                                                                    ?>">
                                <i class="nav-icon fas fa-file-pdf" style="color: #535c66;"></i>
                                <p>
                                    Report
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=payment" class="nav-link      <?php
                                                                                    ...
                                                                                    ?>">
                                <i class="nav-icon fas fa-peso-sign" style="color: #535c66;">₱</i>
                                <p>
                                    Payments
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=feedback" class="nav-link      <?php
                                                                                    ...
                                                                                    ?>">
                                <i class="nav-icon fas fa-mail-bulk" style="color: #535c66;"></i>
                                <p>
                                    Feedbacks
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=search" class="nav-link      <?php
                                                                                    ...
                                                                                    ?>">
                                <i class="nav-icon fas fa-search" style="color: #535c66;"> </i>
                                <p>
                                    Search
                                </p>
                            </a>
                        ...
                        <li class="nav-item">
                            <a href="admin.php?page=logout" class="nav-link">
                                <i class="nav-icon fas fa-power-off" style="color: #535c66;"></i>
                                <p>
                                    Logout
                                </p>
                            </a>
        ...
        <div class="content-wrapper">
            ...
            elseif ($_GET['page'] == 'vehicle')
                include 'admin/vehicle.php';
