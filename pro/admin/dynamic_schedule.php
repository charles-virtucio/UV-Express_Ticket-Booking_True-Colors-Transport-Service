                                        ...
                                        $id = $fetch['id']; ?><tr>
                                            ...
                                            <td>
                                                <form method="POST">
                                                    ...
                                                    <input type="hidden" class="form-control" name="del_vehicle" value="<?php echo $id ?>" required id="">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="" method="post">
                                                            ...
                                                            <p>Driver Name <select class="form-control" name="vehicle_id" required id="">
                                                                    <option value="">Select UV Express</option>
                                                                    <?php
                                                                    $cons = connect()->query("SELECT * FROM vehicle");
                                                                    while ($t = $cons->fetch_assoc()) {
                                                                        echo "<option " . ($fetch['vehicle_id'] == $t['id'] ? 'selected="selected"' : '') . " value='" . $t['id'] . "'>" . $t['name'] . "</option>";
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </p>
                                                            ...
                                                            <p>
                                                                Seat Charge : <input class="form-control" type="number" value="<?php echo $fetch['fee'] ?>" name="fee" required id="">
                                                            </p>
                                                            <p>
                                                                Date :
        ...
        <div class="modal-content" align="center">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                            Driver Name <select class="form-control" name="vehicle_id" required id="">
                                <option value="">Select UV Express</option>
                                <?php
                                $con = connect()->query("SELECT * FROM vehicle");
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            Seat Charge : <input class="form-control" type="number" name="fee" required id="">
                        </div>
                        <div class="col-sm-6">
        ...
        <div class="modal-content" align="center">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            Seat Charge : <input class="form-control" type="number" name="fee" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
...
if (isset($_POST['submit'])) {
    ...
    $time = $_POST['time'];
    if (!isset($route_id, $vehicle_id, $fee, $date, $time)) {
        alert("Fill Form Properly!");
    } else {
        $conn = connect();
        $ins = $conn->prepare("INSERT INTO `schedule`(`vehicle_id`, `route_id`, `date`, `time`, `fee`) VALUES (?,?,?,?,?)");
        $ins->bind_param("iissi", $vehicle_id, $route_id, $date, $time, $fee);
        $ins->execute();
...
if (isset($_POST['edit'])) {
    ...
    if (!isset($route_id, $vehicle_id, $fee, $date, $time)) {
        ...
        $conn = connect();
        $ins = $conn->prepare("UPDATE `schedule` SET `vehicle_id`=?,`route_id`=?,`date`=?,`time`=?,`fee`=? WHERE id = ?");
        $ins->bind_param("iissii", $vehicle_id, $route_id, $date, $time, $fee, $id);
        $ins->execute();
...
if (isset($_POST['del_vehicle'])) {
    $con = connect();
    $conn = $con->query("DELETE FROM schedule WHERE id = '" . $_POST['del_vehicle'] . "'");
