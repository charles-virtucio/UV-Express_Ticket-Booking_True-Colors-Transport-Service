...
<div class="content">
    ...
    <section class="content">
        ...
        <tr><th>UV Express</th><td>" . getVehicleName($row['vehicle_id']) . "</td></tr>
        </table>";
                                }
                            }
