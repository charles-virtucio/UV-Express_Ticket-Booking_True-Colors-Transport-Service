        ...
        <div class="container-fluid">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title"><b>Book UV Express Tickets</b></h3>
                </div>
                <div class="card-body">
                            ...
                            while ($fetch = $row->fetch_assoc()) {
                                ...
                                $id = $fetch['id']; ?><tr>
                                    ...
                                    <td><?php $array = getTotalBookByType($id);
                                        echo ($max_seat = ($array['seat'] - $array['booked'])), " Seat(s) Available";
                                        ?></td>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="<?php echo $_SERVER['PHP_SELF'] . "?loc=$id" ?>" method="post">
                                                    ...
                                                    <p>Number of Tickets (If you are the only one, leave as it is) :
                                                        <input type="number" min='1' value="1" max='<?php echo $max_seat ?>' name="number" class="form-control" id="">
                                                    </p>
                                                    <p>
                                                        Seat Fee: ₱<?php echo $fetch['fee']; ?>
                                                    </p>
